...
{
    public sealed class NotificationOfAntimicrobialDeviceCycleDataFactory : AbstractTriggerEventFactory<NotificationOfAntimicrobialDeviceCycleDataFactory>
    {
